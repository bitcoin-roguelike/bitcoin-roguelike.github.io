...
let Y = (H, e) => 0 != (H & e),
r = H => {
let A = new Uint8Array(H.length);
return H.split("").forEach((H, e) => {
A[e] = H.charCodeAt(0)
}), A
},
t = H => {
var e = new Uint8Array(4);
return e[0] = H, e[1] = H >> 8, e[2] = H >> 16, e[3] = H >> 24, e
},
O = H => {
...
A = 0,
E = H => {
e.set(H, A), A += H.length
};
return E(r("RIFF")), E(t(H.length + 12 + 16 + 8 - 8)), E(r("WAVE")), E(r("fmt ")), E(t(16)), E(O(1)), E(O(1)), E(t(22050)), E(t(22050)), E(O(1)), E(O(8)), E(r("data")), E(t(H.length)), E(H), e
},
l = {
" ": 0,
"!": 2,
...
Y = ["E", "I", "Y"],
l = (H, e, A) => {
if (H.startsWith(O, e) && ((e, A) => {
for (let H = t.length - 1; - 1 < H; H--) {
var E = t[H];
if (U(E, n)) {
if (e[--A] !== E) return !1
} else if (!{
...
"#": () => N(e, --A, 64),
".": () => N(e, --A, 8),
"&": () => N(e, --A, 16) || W(e.substr(--A, 2), ["CH", "SH"]),
"@": () => {
var H;
return !!N(e, --A, 4) || "H" === (H = e[A]) && !!W(H, I)
},
"^": () => N(e, --A, 32),
"+": () => W(e[--A], Y),
":": () => {
for (; 0 <= A && N(e, A - 1, 32);) A--;
return !0
}
}[E]()) return !1
}
...
"#": () => N(e, ++A, 64),
".": () => N(e, ++A, 8),
"&": () => N(e, ++A, 16) || W(e.substr(++A - 2, 2), ["HC", "HS"]),
"@": () => {
var H;
return !!N(e, ++A, 4) || "H" === (H = e[A]) && !!W(H, I)
},
...
"%": () => {
if ("E" !== e[A + 1]) return "ING" === e.substr(A + 1, 3) && (A += 3, !0);
if (N(e, A + 2, n)) {
if (!W(e[A + 2], ["R", "S", "D"])) return "L" !== e[A + 2] ? "FUL" === e.substr(A + 2, 3) && (A += 4, !0) : "Y" === e[A + 3] && (A += 3, !0);
A += 2
} else A++;
return !0
}
...
o = [0, 4626, 4626, 4626, 2056, 2824, 2312, 2824, 3592, 3851, 2822, 4108, 3082, 1541, 1541, 3595, 3082, 3594, 3082, 2825, 2056, 2055, 2825, 2567, 2310, 2056, 2054, 2055, 2055, 2055, 770, 1285, 514, 514, 514, 514, 514, 514, 1542, 1542, 2055, 1542, 1542, 514, 2312, 1027, 513, 286, 3597, 3852, 3852, 3852, 3598, 3593, 2054, 513, 514, 1797, 513, 257, 1798, 513, 514, 1798, 513, 514, 2056, 514, 514, 1540, 514, 514, 1798, 513, 1028, 1798, 257, 1028, 1479, 1535],
Z = (e, A) => {
var H = E.findIndex(H => H === e + A && "*" !== H[1]);
return -1 !== H && H
},
P = e => {
var H = E.findIndex(H => H === e + "*");
return -1 !== H && H
},
b = (r, t, O) => {
...
for (; null !== (R = r(++O));)
if (0 !== R)
if (D(R, $)) A(O + 1, D(R, s) ? 21 : 20, t(O)), H(R, O);
else if (78 === R) e(O, 24);
else if (79 === R) e(O, 27);
else if (80 === R) e(O, 28);
else if (D(R, a) && t(O)) 0 === r(O + 1) && null !== (R = r(O + 2)) && D(R, a) && t(O + 2) && A(O + 2, 31, 0);
else {
var I, Y = 0 === O ? null : r(O - 1);
if (R === B) switch (Y) {
case w:
E(O - 1, 42);
break;
...
default:
D(Y, a) && E(O, 18)
} else 24 === R && D(Y, a) ? E(O, 19) : 60 === Y && 32 === R ? E(O, 38) : 60 === R ? (I = r(O + 1), D(I, s) || null === I || E(O, 63)) : (72 === R && (I = r(O + 1), D(I, s) && null !== I || (E(O, 75), R = 75)), D(R, h) && 32 === Y ? E(O, R - 12) : D(R, h) || H(R, O), 69 !== R && 57 !== R || 0 < O && D(r(O - 1), a) && (0 === (R = r(O + 1)) && (R = r(O + 2)), D(R, a)) && !t(O + 1) && E(O, 30))
}
},
z = (r, t, O) => {
for (let H = 0; null !== r(H); H++)
if (D(r(H), j)) {
for (var e, A = H; 1 < --H && !D(r(H), a););
if (0 === H) break;
for (; H < A; H++) D(r(H), J) && !D(r(H), L) || (e = O(H), t(H, (e >> 1) + e + 1))
}
let R = -1,
I;
for (; null !== (I = r(++R));) {
...
O1.map((H, e) => {
r[0][e] = 255 & H, r[1][e] = H >> 8 & 255, r[2][e] = H >> 16 & 255
});
for (let H = 5; H < 30; H++) r[0][H] = E(e, r[0][H]), r[1][H] = E(A, r[1][H]);
for (let H = 48; H < 54; H++) r[0][H] = E(e, r[0][H]), r[1][H] = E(A, r[1][H]);
return r
},
Y1 = (e, H, A, E) => {
let Y = [e, H[0], H[1], H[2], A[0], A[1], A[2]],
l = (H, e) => Y[H][e],
r = (e, A, E, H) => {
let r = H < 0,
t = Math.abs(H) % e,
...
U = M[n],
N = M[I],
W = (O = N === U ? (t = d[I], d[n]) : N < U ? (t = K[n], d[n]) : (t = d[I], K[I]), (R += E[H][1]) + O),
S = R - t,
f = t + O;
if (0 == (f - 2 & 128)) {
r((N = E[H][1] >> 1) + (U = E[H + 1][1] >> 1), 0, S, e[R + U] - e[R - N]);
for (let H = 1; H < 7; H++) {
var T = l(H, W) - l(H, S);
r(f, H, S, T)
}
...
var l = E[e][0],
n = (l === m ? H(n1, Y, t) : l === y && H(l1, Y, t), r1[E[e][2]]);
for (let H = E[e][1]; 0 < H; H--) O[0][Y] = r[0][l], O[1][Y] = r[1][l], O[2][Y] = r[2][l], R[0][Y] = 255 & C[l], R[1][Y] = C[l] >> 8 & 255, R[2][Y] = C[l] >> 16 & 255, I[Y] = t1[l], t[Y] = A + n & 255, Y++
}
return [t, O, R, I]
},
N1 = (H, e, A, E, r) => {
...
e = Y1(t, O, R, H);
if (!r)
for (let H = 0; H < t.length; H++) t[H] -= O[0][H] >> 1;
var I = [0, 1, 2, 2, 2, 3, 3, 4, 4, 5, 6, 8, 9, 11, 13, 15];
for (let H = R[0].length - 1; 0 <= H; H--) R[0][H] = I[R[0][H]], R[1][H] = I[R[1][H]], R[2][H] = I[R[2][H]];
return [e, O, t, R, E]
},
W1 = H => {
...
[200, 0, 0, 54, 55],
[199, 0, 0, 54, 54]
][r][H]) / 50 | 0) > A.length) throw new Error;
r = H;
for (let H = 0; H < 5; H++) A[(E / 50 | 0) + H] = e[H]
}, t.get = () => A.slice(0, E / 50 | 0), t
},
v = (O, e, H, A) => {
let E = (7 & H) - 1,
R = 256 * E & 65535,
...
let r = 8,
t = R1[R + I];
for (; 0 != (128 & t) ? O(H, e) : O(A, E), t <<= 1, --r;);
};
if (0 === I) {
let H = A >> 4 ^ 255;
for (I = 255 & e; r(3, 26, 4, 6), I++, I &= 255, 255 & ++H;);
return I
}
I ^= 255;
for (var t = 255 & E1[E]; r(2, 5, 1, t), 255 & ++I;);
return e
},
c = H => 127 * Math.sin(2 * Math.PI * (H / 256)) | 0,
S1 = (H, e, A, t, E, O, r) => {
let R = A,
I = 0,
Y = 0,
...
for (; e;) {
var S = r[U];
if (0 != (248 & S)) n = v(H, n, S, E[255 & U]), U += 2, e -= 2, R = A;
else {
{
let e = [],
A = 256 * I,
...
var f = c(255 & A >> 8),
T = c(255 & E >> 8),
i = (255 & r >> 8) < 129 ? -112 : 112,
f = (f * (15 & O[0][U]) + T * (15 & O[1][U]) + i * (15 & O[2][U])) / 32 + 128;
e[H] = 0 | f, A += 256 * t[0][U] / 4, E += 256 * t[1][U] / 4, r += 256 * t[2][U] / 4
}
H.ary(0, e)
}
if (0 == --R) {
...
H = (H => {
if (!H) return !1;
let e = H => H === I.length ? null : I[H],
A = (e, H, A, E) => {
for (let H = I.length - 1; H >= e; H--) I[H + 1] = I[H], R[H + 1] = t(H), O[H + 1] = r(H);
I[e] = H, R[e] = 0 | E, O[e] = A
},
r = H => 0 | O[H],
t = H => 0 | R[H],
...
O[H] = e
}), e1(e, r, E), z(e, E, t), A1(e, A, r), I.map((H, e) => H ? [H, 0 | R[e], 0 | O[e]] : null).filter(H => H)
})(H);
return !1 !== H && (r = void 0 === (r = O.pitch) ? 64 : 255 & r, A = void 0 === (A = O.mouth) ? 128 : 255 & A, E = void 0 === (E = O.throat) ? 128 : 255 & E, e = 255 & (O.speed || 72), O = O.singmode || !1, r = N1(H, r, A, E, O), A = W1(176.4 * H.reduce((H, e) => H + e[1], 0) * e | 0), [E, O, H, r, t] = r, S1(A, E, e, O, H, r, t), A.get())
}
let F = H => {
let e = " " + H.toUpperCase(),
A = 0,
...
t = 0;
for (; A < e.length && t++ < 1e4;) {
var O = e[A];
if ("." !== O || N(e, A + 1, 1))
if (U(O, 2)) f.some(H => H(e, A, r));
else if (0 !== l[O]) {
if (!U(O, n)) return !1;
S[O].some(H => H(e, A, r))
} else E += " ", A++;
...
// Browser global – expose as TALK instead of TalkJs
(e = typeof globalThis !== "undefined" ? globalThis : e || self).TalkJs = TALK();
}
